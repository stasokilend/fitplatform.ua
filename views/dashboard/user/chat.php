...
// Получаем пользователей для нового чата
$stmt = $pdo->prepare("
...
<div class="fade-in-up">
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-3 mb-4 border-bottom">
        <h1 class="h2">
            <i class="bi bi-chat-dots text-primary"></i> Чат
        </h1>
                ...
                <div class="card-header bg-transparent border-0">
                    <h6 class="mb-0">
                        ...
                        ?>
                            ...
                            <?php echo htmlspecialchars($otherUser['other_user_name'] ?? 'Чат'); ?>
                        <?php else: ?>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label class="form-label">Виберіть користувача</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('createChatBtn').addEventListener('click', function() {
        ...
        if (!userId) {
            showToast('Виберіть користувача', 'warning');
            return;
        }
