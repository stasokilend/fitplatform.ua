...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'update_profile') {
        ...
        // error_log('Updating profile for user ' . $userId . ': ' . print_r($data, true));
                ...
                <div class="card-body">
                    ...
                    <?php if ($isGoogleFitConnected): ?>
                        <div class="mt-3">
                            ...
                            <span class="text-muted ms-2 small">Остання синхронізація: <?php echo $googleFit->getSyncStatus() ? date('d.m.Y H:i', strtotime($googleFit->getSyncStatus()['sync_start'])) : 'ніколи'; ?></span>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
